...
publication and reproduction evidence; it does not erase prior attempts. No public CLI wraps reservation-hold release, so deployment tooling must expose it under its
