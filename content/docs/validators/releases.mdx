...
<Callout type="error" title="Use the canonical acceptance gate">
  ...
  requires the complete [publication checklist](/docs/engine/release-workflow#publication-checklist),
  ...
  dated [State of record](/docs/reference/state-of-record) before operating this sequence.
</Callout>
...
<Callout type="warn" title="Production validation gate">
  ...
  [State of record](/docs/reference/state-of-record) before claiming that any operational
