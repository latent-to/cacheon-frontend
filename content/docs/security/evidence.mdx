...
[`optima/audit.py`](https://github.com/latent-to/optima/blob/main/optima/audit.py) can emit sampled comparison receipts for supported live dispatch seams when its runtime
