---
title: Copy and priority controls
---
...
operations and attribute structure. There is no equivalent semantic CUDA parser in the
current implementation. Renaming CUDA identifiers and changing constants can evade that
advisory layer.
...
- [Submitted-delta fingerprints](https://github.com/latent-to/optima/blob/main/optima/copy_fingerprint.py)
- [Finalized copy reconciliation](https://github.com/latent-to/optima/blob/main/optima/chain/intake.py)
- [Validator loop integration](https://github.com/latent-to/optima/blob/main/optima/chain/validator_loop.py)
- [Copy behavior tests](https://github.com/latent-to/optima/blob/main/tests/test_copy_fingerprint.py)
