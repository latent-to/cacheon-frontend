...
This history records architectural changes and the evidence available when they landed. It is not the current operator contract. For present capabilities, limitations, and validation status, use [State of record](/docs/reference/state-of-record).
...
Foundation commit: [`d066d45`](https://github.com/latent-to/optima/commit/d066d45).
...
Representative changes: [PR #1](https://github.com/latent-to/optima/pull/1), [PR #3](https://github.com/latent-to/optima/pull/3), [PR #4](https://github.com/latent-to/optima/pull/4), and [PR #5](https://github.com/latent-to/optima/pull/5).
...
Representative changes: [PR #6](https://github.com/latent-to/optima/pull/6), [PR #8](https://github.com/latent-to/optima/pull/8), [PR #9](https://github.com/latent-to/optima/pull/9), and [PR #11](https://github.com/latent-to/optima/pull/11).
...
Changes: [PR #12](https://github.com/latent-to/optima/pull/12) and [PR #13](https://github.com/latent-to/optima/pull/13).
...
Changes: [PR #14](https://github.com/latent-to/optima/pull/14), [PR #15](https://github.com/latent-to/optima/pull/15), [PR #16](https://github.com/latent-to/optima/pull/16), and [PR #17](https://github.com/latent-to/optima/pull/17).
...
Changes: [PR #18](https://github.com/latent-to/optima/pull/18), [PR #19](https://github.com/latent-to/optima/pull/19), [PR #20](https://github.com/latent-to/optima/pull/20), [PR #21](https://github.com/latent-to/optima/pull/21), and [PR #22](https://github.com/latent-to/optima/pull/22).
...
Changes: [PR #23](https://github.com/latent-to/optima/pull/23), [PR #24](https://github.com/latent-to/optima/pull/24), and [PR #25](https://github.com/latent-to/optima/pull/25).
...
Change: [`4eef097`](https://github.com/latent-to/optima/commit/4eef097).
...
Change: [PR #26](https://github.com/latent-to/optima/pull/26).
...
Changes: [PR #27](https://github.com/latent-to/optima/pull/27), [PR #28](https://github.com/latent-to/optima/pull/28), [PR #29](https://github.com/latent-to/optima/pull/29), and [PR #30](https://github.com/latent-to/optima/pull/30).
...
A donor implementation at `1b1c842b` was retained as an architectural reference but not merged wholesale. Current main was built through bounded source extraction from [`203bb559`](https://github.com/latent-to/optima/commit/203bb559).
...
Merged changes: [#31](https://github.com/latent-to/optima/pull/31), [#32](https://github.com/latent-to/optima/pull/32), [#33](https://github.com/latent-to/optima/pull/33), [#34](https://github.com/latent-to/optima/pull/34), [#35](https://github.com/latent-to/optima/pull/35), [#36](https://github.com/latent-to/optima/pull/36), [#37](https://github.com/latent-to/optima/pull/37), [#38](https://github.com/latent-to/optima/pull/38), and [#39](https://github.com/latent-to/optima/pull/39).
...
Merged changes: [#40](https://github.com/latent-to/optima/pull/40), [#41](https://github.com/latent-to/optima/pull/41), [#42](https://github.com/latent-to/optima/pull/42), [#43](https://github.com/latent-to/optima/pull/43), [#44](https://github.com/latent-to/optima/pull/44), [#45](https://github.com/latent-to/optima/pull/45), and [#46](https://github.com/latent-to/optima/pull/46).
...
Merged changes: [#47](https://github.com/latent-to/optima/pull/47), [#48](https://github.com/latent-to/optima/pull/48), [#49](https://github.com/latent-to/optima/pull/49), [#50](https://github.com/latent-to/optima/pull/50), and [#51](https://github.com/latent-to/optima/pull/51).
...
Change: [PR #52](https://github.com/latent-to/optima/pull/52).
...
Change: [PR #53](https://github.com/latent-to/optima/pull/53).
...
Change: [PR #54](https://github.com/latent-to/optima/pull/54).
...
Changes: [PR #55](https://github.com/latent-to/optima/pull/55) and [PR #56](https://github.com/latent-to/optima/pull/56). The latter only clarified that the value embedded in the container context is an Ed25519 public verification key.

## 2026-07-13 — B300 intake findings after main

Three focused changes landed on the `fix/b300-intake-findings` working branch after
the PR #56 main snapshot:
...
These are current working-tree contracts, not merged pull requests or commits
reachable from an `origin/*` ref at this snapshot. Focused regressions and the
current 1,724-passed/18-skipped/0-failed suite are green; the final B300 joined
qualification remains a separate evidence claim.

## Corrections and retractions

### MXFP4 throughput claim retracted — 2026-06-07

An early sm120/MXFP4 example was described as a submitted throughput improvement before it had passed Cacheon's scored end-to-end gate. Commit [`c83c5a9`](https://github.com/latent-to/optima/commit/c83c5a9) removed the slot/example and the unsupported throughput language while retaining the useful generic MoE and cosine-correctness machinery.

### Weight submission truthfulness — 2026-07

The earlier chain adapter could report `submitted=true` even when the extrinsic failed, which could suppress a necessary retry. Commit [`20b8d674`](https://github.com/latent-to/optima/commit/20b8d674) corrected the immediate bug. The final economics design institutionalized the lesson: submission intent, release, and confirmation are separate persisted states, and an SDK return value alone never confirms weights.
...
The live slot catalog contains 11 slots, not 10. `attention.msa_prefill_block_score` is the additional current slot. The executable [`slots.py`](https://github.com/latent-to/optima/blob/main/optima/slots.py) catalog is authoritative.
...
| Post-main CuTe admission, scheduler-only load gate, and shared DSL-JIT policy | Working branch | `804147c4`, `3cff4731`, `5325468a` |

## Current interpretation

The history resolves into three layers:
...
3. the July hardening rebuilt authority so those ideas can be evaluated marginally, reproduced independently, settled transactionally, integrated as reviewed source, and shipped without chain dependencies.

Only the third layer defines current crown and release authority. See [State of record](/docs/reference/state-of-record) for the remaining validation debt and [Architecture overview](/docs/architecture/overview) for the stable model.
