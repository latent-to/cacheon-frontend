...
<Callout type="info" title="Operational status">
  These gates are implemented and tested, but the current evidence ledger does not claim the final
  real registry double-build, TP8 serve, and receipt smoke have been completed.
</Callout>
