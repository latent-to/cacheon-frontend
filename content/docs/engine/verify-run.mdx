...
<Callout type="error" title="Verification primitives are not rollout authority">
  ...
  before authorization or start. The dated [State of record](/docs/reference/state-of-record) records the pinned implementation's
...
<Callout type="warn" title="Operational proof requirement">
  ...
  applicable). See [State of record](/docs/reference/state-of-record) for completed evidence.
</Callout>
