---
title: Integrating a contribution
---
...
owned, understood, maintained, composed with today's reviewed Engine, and distributed
...
[`optima/engine_tree.py`](https://github.com/latent-to/optima/blob/main/optima/engine_tree.py).
