...
| Tracing-JIT admission              | [`dsl_jit_policy.py`](https://github.com/latent-to/optima/blob/main/optima/dsl_jit_policy.py)                                                                                                       |
...
| Scheduler-role candidate load      | [`seam.py`](https://github.com/latent-to/optima/blob/main/optima/seam.py), [`sglang_scheduler_gate.py`](https://github.com/latent-to/optima/blob/main/optima/integrations/sglang_scheduler_gate.py) |

## Sealed direct artifacts

| Area                                           | Primary source                                                                                                                                                                                           |
| ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Closed provider policy                         | [`artifact_provider.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_provider.py)                                                                                                      |
| Slot call ABI, resources, and lifecycle        | [`artifact_abi.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_abi.py), [`artifact_runtime.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_runtime.py)             |
| Canonical direct-execution identity            | [`artifact_identity.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_identity.py), [`artifact_resource_identity.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_resource_identity.py) |
| Declarative device launch                      | [`artifact_device_launch.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_device_launch.py)                                                                                            |
| CUBIN ABI and Driver admission                 | [`cuda_cubin.py`](https://github.com/latent-to/optima/blob/main/optima/cuda_cubin.py), [`cuda_launch.py`](https://github.com/latent-to/optima/blob/main/optima/cuda_launch.py)                           |
| Parameter, TMA, and FastDivmod materialization | [`cuda_materialize.py`](https://github.com/latent-to/optima/blob/main/optima/cuda_materialize.py)                                                                                                        |
| CuTe compiler boundary and sealed index        | [`cute_aot.py`](https://github.com/latent-to/optima/blob/main/optima/cute_aot.py), [`cute_cubin.py`](https://github.com/latent-to/optima/blob/main/optima/cute_cubin.py)                                 |
| Measured compile profile                       | [`eval/native_compile_profile.py`](https://github.com/latent-to/optima/blob/main/optima/eval/native_compile_profile.py)                                                                                  |
| Registered build patcher                       | [`patchers/build_cute_cubin.py`](https://github.com/latent-to/optima/blob/main/optima/patchers/build_cute_cubin.py)                                                                                      |
| Rank-local post-CUDA binding                   | [`integrations/sglang_artifact_context.py`](https://github.com/latent-to/optima/blob/main/optima/integrations/sglang_artifact_context.py)                                                                |
...
| Compile-profile and multi-architecture prebuild | [`eval/native_compile_profile.py`](https://github.com/latent-to/optima/blob/main/optima/eval/native_compile_profile.py), [`eval/oci_prebuild.py`](https://github.com/latent-to/optima/blob/main/optima/eval/oci_prebuild.py) |
...
treating them as confirmation, and reconciles later chain observation. The
journal stores status/chronology metadata and a projection digest, not raw
pre/post readback vectors. `--dry-run` creates no journal intent, while
reconciliation and submission have different durable states.
