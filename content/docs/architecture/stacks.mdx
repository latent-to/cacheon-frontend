...
See [Sealed direct artifacts](/docs/architecture/direct-artifacts) for the complete contract.
...
- [`artifact_identity.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_identity.py) — canonical direct-artifact execution identity
- [`artifact_provider.py`](https://github.com/latent-to/optima/blob/main/optima/artifact_provider.py) — closed provider registry included in catalog identity
