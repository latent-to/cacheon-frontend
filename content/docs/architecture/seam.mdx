...
the current pin preserves candidate execution and measured performance. Check
[State of record](/docs/reference/state-of-record) for the dated claim boundary and
[SGLang compatibility](/docs/dev/sglang-tracking) for the complete validation ladder.
</Callout>
