...
<Callout type="warn" title="Pin-validation boundary">
  A green import/chokepoint canary is necessary compatibility evidence, not proof that a pin
  preserves candidate execution and measured performance. Check [State of
