...
Slots may evolve, SGLang adapters may churn, and correctness policies may be recalibrated. Every core slot must still satisfy the four invariants on this page. The normative checklist is [`docs/SLOT_CONTRACT.md`](https://github.com/latent-to/cacheon/blob/main/docs/SLOT_CONTRACT.md); the executable catalog is [`optima/slots.py`](https://github.com/latent-to/cacheon/blob/main/optima/slots.py).
...
See [Product model](/docs/architecture/product-model) and [`target_catalog.py`](https://github.com/latent-to/cacheon/blob/main/optima/target_catalog.py).
...
- [`docs/SLOT_CONTRACT.md`](https://github.com/latent-to/cacheon/blob/main/docs/SLOT_CONTRACT.md) — normative invariants
