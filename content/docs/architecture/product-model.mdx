...
The [canonical product contract](https://github.com/latent-to/cacheon/blob/main/docs/PRODUCT_CONTRACT.md) is the normative source for this boundary.
...
- [`docs/PRODUCT_CONTRACT.md`](https://github.com/latent-to/cacheon/blob/main/docs/PRODUCT_CONTRACT.md) — normative product invariants
