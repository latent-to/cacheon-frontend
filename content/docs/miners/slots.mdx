...
Their target contracts grade the validator-owned top-k result. The prefill slot
is a distinct long-prefill boundary and its canonical live descriptor is eager;
do not assume a decode optimization exercises it.
