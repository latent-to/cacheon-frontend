...
[performance-development procedure](/docs/validators/running-evals#performance-development)
...
B, C, B′, pristine T, resources, graph evidence, hidden inputs, and calibrated policies,
then requires a separately bound reproduction.
