...
the full [product contract](https://github.com/latent-to/cacheon/blob/main/docs/PRODUCT_CONTRACT.md)
...
[economics implementation](https://github.com/latent-to/cacheon/blob/main/optima/economics.py)
