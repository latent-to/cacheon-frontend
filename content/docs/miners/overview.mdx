...
python -m optima.cli evaluate my_bundle --model <arena-model> ...
python -m optima.cli bench my_bundle --model <arena-model> ...
```

These commands help find manifest, ABI, correctness, graph, fidelity, and
performance problems. They do **not** reproduce crown authority: a local run
