...
The current admission logic is pinned in the post-main working-tree paths
`optima/dsl_jit_policy.py` and `optima/engine_tree.py` at the commit named in
[State of record](/docs/reference/state-of-record).
