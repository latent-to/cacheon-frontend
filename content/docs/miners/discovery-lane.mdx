...
See
[economics.py](https://github.com/latent-to/cacheon/blob/main/optima/economics.py)
for bounty claims and
[PRODUCT_CONTRACT.md](https://github.com/latent-to/cacheon/blob/main/docs/PRODUCT_CONTRACT.md)
