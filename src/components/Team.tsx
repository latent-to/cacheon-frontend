...
export default function Team() {
  return (
    <section id="team" className="relative border-t border-border/50">
      <div className="mx-auto max-w-6xl px-6 py-28 max-sm:py-16">
        <SectionHeader
          eyebrow="04 — Team"
          title="The people building Cacheon."
        />
  ...
  return (
    <div className="group rounded-xl border border-border/60 bg-surface/60 p-5 backdrop-blur-sm transition-colors hover:border-accent/30">
      <div className="mb-4 size-12 overflow-hidden rounded-full border border-border/60">
        ...
        />
        <div
          className="hidden h-full w-full items-center justify-center bg-accent/10 font-mono text-base font-bold text-accent"
          aria-hidden
        >
